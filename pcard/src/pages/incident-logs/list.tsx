        ...
        items={[
          {
            key: "all",
            label: "All",
            children: renderTable(allTbl.tableProps),
          },
          {
            key: "open",
            label: "Open",
            children: renderTable(openTbl.tableProps),
          },
          {
            key: "closed",
            label: "Closed",
            children: renderTable(closedTbl.tableProps),
          },
          {
            key: "draft",
            label: "Draft",
            children: renderTable(draftTbl.tableProps),
          },
          {
            key: "categories",
            label: "Categories",
            children: (
              <CategoriesBox
                onReady={(api) => {
                  catCreateRef.current = api.openCreate;
                }}
              />
            ),
          },

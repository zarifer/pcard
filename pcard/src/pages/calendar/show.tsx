...
export const CalendarShow = ({ visible, onClose, eventId }: { visible: boolean, onClose: () => void, eventId: string }) => {
        ...
        >
            <div style={{ padding: 32 }}>
                <Space direction="vertical" size={20} style={{ width: "100%" }}>
                    ...
                    <Typography.Title level={3} style={{ color, fontWeight: 800, margin: 0 }}>
                        {event.title}
                    </Typography.Title>

                    <Tag color={color} style={{ fontWeight: 600, fontSize: 16, padding: "2px 14px" }}>
                        {event.type}
                    </Tag>
